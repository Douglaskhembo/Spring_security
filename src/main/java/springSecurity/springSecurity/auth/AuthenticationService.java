package springSecurity.springSecurity.auth;
...
public class AuthenticationService {
    ...
    public void refreshToken(
        ...
        //extracting userEmail from database and ensure it's not null
        if (userEmail != null ){
